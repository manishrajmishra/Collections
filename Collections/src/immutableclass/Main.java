...
//	     this was the challenge part to deal with null exception when it was called
...
//	     locations.get(5).addExits("Q", 0);
	     ...
	     while(true) {
	    	 ...
	    	 // this is concept of "immutable class" which means that the variable created cannot be deleted
	    	 tempExit.remove("S");
	    	 if(loc == 0) {
	    		 break;
	    	 }
